(function(window){
  ...
  var RECORDER_WORKER_PATH  = 'http://www.tuer.me/MP3RecorderJS/js/recorderWorker.js';
  var ENCODER_WORKER_PATH   = 'http://www.tuer.me/MP3RecorderJS/js/mp3Worker.js';
  ...
  var MP3Recorder = function(context, stream, cfg) {
    ...
    this.exportMP3 = function(cb) {
      this.logStatus('转码中,时间可能较长请耐心等待...');
